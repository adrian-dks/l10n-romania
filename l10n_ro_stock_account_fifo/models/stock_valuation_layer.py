...
class StockValuationLayer(models.Model):
    ...
    svl_dest_ids = fields.Many2many("stock.valuation.layer", compute="_compute_SrcDest")
    svl_src_ids = fields.Many2many("stock.valuation.layer", compute="_compute_SrcDest")

    def _compute_SrcDest(self):
        for s in self:
    ...
    def _create_tracking(self, source_svl_qty):
        ...
        svl_tracking_ids = self.env["stock.valuation.layer.tracking"].create(
            tracking_values
        )
