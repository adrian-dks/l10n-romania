...
class StockMove(models.Model):
    ...
    def _create_in_svl(self, forced_quantity=None):
        if self.env.context.get("standard") and self.company_id.l10n_ro_accounting:
            ...
            for move in self:
                ...
                for valued_move_line in valued_move_lines:
                    ...
                    if (
                        ...
                        origin_domain = move.product_id._prepare_domain_fifo(
            ...
            return super(StockMove, self)._create_in_svl(
    ...
    def _create_out_svl(self, forced_quantity=None):
        if self.env.context.get("standard") and self.company_id.l10n_ro_accounting:
            ...
            for move in self:
                ...
                for valued_move_line in valued_move_lines:
                    ...
                    if float_is_zero(
                        ...
                        continue
                    svl_vals_list = (
                        valued_move_line.product_id._prepare_out_svl_vals_ro(
                            forced_quantity or valued_quantity,
            ...
            return super(StockMove, self)._create_out_svl(
                forced_quantity=forced_quantity
            )
