...
class ProductFifo(models.Model):
    ...
    def _prepare_domain_fifo(self, domain=None):
        if not domain:
            domain = []
        lot_id = loc_id = None
    ...
    def _run_fifo_ro(self, quantity, company):
        ...
        domain = self._prepare_domain_fifo([("product_id", "=", self.id)]) + [
            ("remaining_qty", ">", 0),
            ("remaining_value", ">", 0),
        ...
        for candidate in candidates:
            ...
            if float_is_zero(
                ...
                #    new_standard_price = next_candidates and
                #    next_candidates[0].unit_cost or new_standard_price
                break
