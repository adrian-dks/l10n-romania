...
class ResCompany(models.Model):
    ...
    def init(self):
        ...
        self._cr.execute("UPDATE res_company set l10n_ro_accounting = TRUE, anglo_saxon_accounting = TRUE, l10n_ro_stock_acc_price_diff = TRUE where id in %s", (tuple(ro_comp.ids),))
        # ro_comp.write(
        #     {
